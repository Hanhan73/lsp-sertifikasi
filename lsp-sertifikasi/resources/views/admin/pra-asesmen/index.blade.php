            ...
            <div class="tab-pane fade show active" id="tab-kolektif">
                ...
                <div class="d-flex gap-2 mb-3 flex-wrap">
                    ...
                    <select id="batch-status-filter" class="form-select form-select-sm" style="width:auto;">
                        ...
                        <option value="pra_asesmen_started">Asesmen Dimulai</option>
                ...
                <div id="batch-list">
                    ...
                    <div class="batch-card batch-item" data-batch-id="{{ $batchId }}"
                        ...
                        <div class="batch-header" onclick="toggleBatch(this)">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <span class="spill spill-done"><i class="bi bi-check2-circle"></i> Semua Sudah
                                        Diases</span>
                                    @else
                        ...
                        <div class="batch-body" style="display:none;">
                            <div class="table-responsive">
                                <table class="table table-sm align-middle mb-0" style="font-size:.83rem;">
                                    <thead
                                        style="background:#f8fafc; color:#64748b; font-size:.72rem; text-transform:uppercase;">
                                        <tr>
