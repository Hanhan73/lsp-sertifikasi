...
<div class="card" style="max-width:720px">
    <div class="card-header bg-white">
        <h5 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Surat Masuk</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.surat.masuk.update', $surat) }}" method="POST" enctype="multipart/form-data">
            @csrf @method('PUT')
            @include('admin.surat.masuk._form', ['surat' => $surat])
