    ...
    <div class="card-body py-3">
        <form method="GET" class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <div class="ms-auto d-flex gap-2">
                <a href="{{ route('direktur.keuangan.buku-besar.export', ['tahun'=>$tahun,'akun_id'=>$selectedAkun?->id,'format'=>'pdf']) }}"
                class="btn btn-sm btn-outline-danger">
                    <i class="bi bi-file-earmark-pdf"></i> PDF
                </a>
                <a href="{{ route('direktur.keuangan.buku-besar.export', ['tahun'=>$tahun,'akun_id'=>$selectedAkun?->id,'format'=>'excel']) }}"
                class="btn btn-sm btn-outline-success">
                    <i class="bi bi-file-earmark-excel"></i> Excel
                </a>
            </div>

            <a href="{{ route('direktur.keuangan.index', ['tahun' => $tahun]) }}"
