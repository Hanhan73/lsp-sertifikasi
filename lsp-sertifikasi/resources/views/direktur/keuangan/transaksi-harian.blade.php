    ...
    <div class="card-body py-3">
        <form method="GET" class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <div class="ms-auto d-flex gap-2">
                <a href="{{ route('direktur.keuangan.transaksi-harian', ['tanggal' => \Carbon\Carbon::parse($tanggal)->subDay()->toDateString()]) }}"
                    class="btn btn-sm btn-outline-secondary">
                    <i class="bi bi-chevron-left"></i>
                </a>
                <a href="{{ route('direktur.keuangan.transaksi-harian', ['tanggal' => today()->toDateString()]) }}"
                    class="btn btn-sm btn-outline-primary">Hari Ini</a>
                <a href="{{ route('direktur.keuangan.transaksi-harian', ['tanggal' => \Carbon\Carbon::parse($tanggal)->addDay()->toDateString()]) }}"
                    class="btn btn-sm btn-outline-secondary">
        ...
        <div class="ms-auto d-flex gap-2">
            <a href="{{ route('direktur.keuangan.transaksi-harian.export', ['tanggal'=>$tanggal,'format'=>'pdf']) }}"
                class="btn btn-sm btn-outline-danger">
                <i class="bi bi-file-earmark-pdf"></i> PDF
            </a>
            <a href="{{ route('direktur.keuangan.transaksi-harian.export', ['tanggal'=>$tanggal,'format'=>'excel']) }}"
