{{-- resources/views/manajer-sertifikasi/soal-observasi/create.blade.php --}}
@extends('layouts.app')

@section('title', 'Upload Soal Observasi')
@section('breadcrumb', 'Bank Soal › Soal Observasi › Upload')
    ...
    <div class="col-md-7">
        <div class="card">
            <div class="card-header">
                <h6 class="fw-bold mb-0"><i class="bi bi-cloud-upload text-primary me-2"></i>Form Upload</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('manajer-sertifikasi.soal-observasi.store') }}"
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Judul Soal Observasi <span
                                class="text-danger">*</span></label>
                        <input type="text" name="judul" value="{{ old('judul') }}"
                            class="form-control @error('judul') is-invalid @enderror"
                            placeholder="cth: Lembar Observasi Kompetensi Unit 1" required>
