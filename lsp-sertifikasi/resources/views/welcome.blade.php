    ...
    <section class="access-section">
        <div class="container">
            <div class="section-title" data-aos="flip-up">
                ...
                <p>Pilih peran Anda untuk mengakses sistem sertifikasi</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6" data-aos="flip-left" data-aos-delay="100">
                    <div class="access-card" onclick="window.location.href='{{ route('register') }}'">
                        <div class="access-icon">
                            <i class="bi bi-person-badge"></i>
                        </div>
                        <h3>Asesi</h3>
                        <p>Daftar sertifikasi, upload dokumen, dan pantau status sertifikasi Anda</p>
                ...
                <div class="col-lg-4 col-md-6" data-aos="flip-left" data-aos-delay="200">
                    <div class="access-card" onclick="window.location.href='{{ route('login') }}'">
                        <div class="access-icon"
                            style="background: linear-gradient(135deg, var(--accent-red), #FF6B6B);">
                            <i class="bi bi-building"></i>
                        </div>
                        <h3>TUK</h3>
                        <p>Kelola pendaftaran kolektif, verifikasi, dan jadwalkan asesmen</p>
                        <a href="{{ route('login') }}" class="btn btn-danger"
                            style="background: var(--accent-red); border: none;">
                            <i class="bi bi-box-arrow-in-right"></i> Login TUK
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6" data-aos="flip-left" data-aos-delay="300">
                    <div class="access-card" onclick="window.location.href='{{ route('login') }}'">
                        <div class="access-icon" style="background: linear-gradient(135deg, #43A047, #66BB6A);">
                            <i class="bi bi-shield-check"></i>
                        </div>
                        <h3>Admin LSP</h3>
                        <p>Verifikasi pendaftaran, kelola skema, dan terbitkan sertifikat</p>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2024 SIKAP LSP. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
